...
void ZDZD_lhe(TString powhegLheFile = "cmsgrid_final.lhe", TString outputFile = "cmsgrid_final.root", long int Nevents = 10000, bool bApplyCuts = true, unsigned int kDebugLevel = 1) {
// define input
    ifstream in;
    ...
    while (1) {
        ...
        if (kDebugLevel>0){
            if ((nLHEevents%1000) == 0)printf("Analysed %lu events\n",nLHEevents);
        }
        ...
        if ( (sumAbsId!=44 && sumAbsId!=48 && sumAbsId!=52) || (sumAbsId==52 && (fabs(id1)==15 || fabs(id2)==15 || fabs(id3)==15 || fabs(id4)==15)) ) {
            ...
            if ( (!bApplyCuts) || ( (pto1>20.0 && pto2>10.0 && pto3>5.0 && pto4>5.0) 
                                    ...
                                    && (4.0<massZ1) && (massZ1<62.5) && (4.0<massZ2) && (massZ2<62.5) && (fabs(massZ1-massZ2)/(massZ1+massZ2)<0.05) ) ) {
